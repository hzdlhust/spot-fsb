...
//                    PropritiesHelper.getPropritiesFile(analyzeModel.get(i));
//                    sb.append(analyzeModel.get(i));

                }
//                sb.append("\nauxModel\n");
                for (int i = 0; i < auxModel.getSize(); i++) {
                    p.addAuxClasspathEntry(auxModel.get(i));
//                    sb.append(auxModel.get(i));
                }
                List<String> sourceDirs = new ArrayList<>(sourceModel.getSize());
//                sb.append("\nsourceModel\n");
                for (int i = 0; i < sourceModel.getSize(); i++) {
                    sourceDirs.add(sourceModel.get(i));
//                    sb.append(sourceModel.get(i));
                }

                /*
                try{
                    sb.append(PropritiesHelper.jarToProper);
                    sb.append(PropritiesHelper.getPropritiesVaule("thing","thing"));
                    f = new File("D:\\1.txt");
