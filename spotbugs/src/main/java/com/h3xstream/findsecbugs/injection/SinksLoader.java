...
*/
            ...
            String newstr = SINK_CONFIG_PATH.concat(filename);
            stream = cl.getResourceAsStream(newstr);
//            stream = getClass().getResourceAsStream(newstr);
            /**
            ...
            stream = new FileInputStream(new File(SINK_CONFIG_PATH));
             */
