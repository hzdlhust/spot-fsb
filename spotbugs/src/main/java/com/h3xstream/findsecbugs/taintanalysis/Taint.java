...
public class Taint {
    ...
    public Map<Integer,State> innerArray;
    ...
    public Taint(State state) {
        ...
        innerArray = new HashMap<Integer, State>();
    }
    ...
    public void initArray(){
        if(innerArray == null)  innerArray = new HashMap<Integer, State>();
    }
    ...
    public int getVariableIndex() {
        if (variableIndex == INVALID_INDEX) return -1;
